...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="/~S4334970/SauceForYou/nav/bootstrap.min.css">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
          ...
          <span><p>&nbsp;&nbsp;</p></span>
          <div>
            <form action="/~S4334970/SauceForYou/php/search.php" method="GET">
              <input type="text" name="query" />
              <input type="submit" value="Cerca nei sughi disponibili"/>
            </form>
          </div>
